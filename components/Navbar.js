...
const Navbar = () => {
  ...
  return (
    ...
    <nav className="bg-green-550 py-2 pt-4 text-white fixed top-0 left-0 w-full z-20 shadow-md backdrop-filter backdrop-blur-lg bg-opacity-30 ">
      <div className="flex flex-row items-center justify-between px-8">
        <div className="mb-4">
          <h1 className="text-4xl font-bold text-green-700">
            <Link href="/">FarmToTable</Link>
          </h1>
          <p className="mt-2 text-md text-green-700">Promoting sustainable agriculture and local farming.</p>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="dropdown-menu absolute right-0 w-56 p-1 bg-white bg-opacity-90 text-black text-2xl rounded-md shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible backdrop-filter backdrop-blur-lg">
              <Link href="/buy" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  className="mr-2 text-2xl" icon={faShoppingBag} /> Buy
              </Link>
              <Link href="/sell" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faSeedling} className="mr-2 text-2xl" /> Sell
              </Link>
              ...
              <Link href="/crop_safety" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faShieldAlt} className="mr-2 text-2xl" /> Crop Safety
              </Link>
            </div>
          </div>
          <div className="relative group">
            ...
            <div className="dropdown-menu absolute right-0 w-60 p-1 bg-white bg-opacity-90 text-black text-2xl rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible backdrop-filter backdrop-blur-lg">
              <Link href="/myproducts" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faBoxOpen} className="mr-2 text-2xl" /> My Products
              </Link>
              <Link href="/orders-received" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faClipboardList} className="mr-2 text-2xl" /> Orders
              </Link>
              <Link href="/cart" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faShoppingCart} className="mr-2 text-2xl" /> Cart
              </Link>
            </div>
          </div>
          <div className="relative group">
            ...
            <div className="dropdown-menu absolute right-0 w-56 p-1 bg-white bg-opacity-90 text-black text-2xl rounded-md shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible backdrop-filter backdrop-blur-lg">
              <Link href="/dashboard" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faTachometerAlt} className="mr-2 text-2xl" /> Dashboard
              </Link>
              <Link href="/about" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faInfoCircle} className="mr-2 text-2xl" /> About
              </Link>
              {session ? (
                <button
                  onClick={() => signOut()}
                  className="block w-full text-left px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md"
                >
                  <FontAwesomeIcon  icon={faSignOutAlt} className="mr-2 text-2xl" /> Log Out
                </button>
              ) : (
                <Link href="/login" className="block px-4 py-2 text-gray-800 hover:bg-green-550 hover:shadow-xl hover:text-white rounded-md">
                <FontAwesomeIcon  icon={faSignOutAlt} className="mr-2 text-xl" /> Log In
              </Link>
              )}
            </div>
          </div>
