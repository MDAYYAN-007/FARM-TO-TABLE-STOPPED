...
const Navbar = () => {
  return (
      ...
      <nav className="bg-green-550 py-2 text-white fixed top-0 left-0 w-full z-20 shadow-md">
        <div className="flex flex-row items-center justify-between px-4">
          ...
          <div className="flex space-x-6 text-lg items-center">
            ...
            <div className="relative group">
              ...
              <div className="dropdown-menu absolute right-0 w-48 p-1 bg-white text-black rounded-md shadow-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible">
            ...
            <div className="relative group">
              ...
              <div className="dropdown-menu absolute right-0 w-48 p-1 bg-white text-black rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 invisible group-hover:visible">
